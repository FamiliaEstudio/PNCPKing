...
public sealed class Schema18MigrationTests
{
    ...
    public async Task Migration17To18_CreatesExactIndexPreservesDataAndIsIdempotent()
    {
        ...
        Assert.Equal(20, result.CurrentVersion);
        Assert.Equal([18, 19, 20], result.AppliedMigrations);
        ...
        Assert.Equal(20, repeated.PreviousVersion);
        Assert.Equal(20, repeated.CurrentVersion);
