...
public sealed class Schema18MigrationTests
{
    ...
    public async Task Migration17To18_CreatesExactIndexPreservesDataAndIsIdempotent()
    {
        ...
        Assert.Equal(21, result.CurrentVersion);
        Assert.Equal([18, 19, 20, 21], result.AppliedMigrations);
        ...
        Assert.Equal(21, repeated.PreviousVersion);
        Assert.Equal(21, repeated.CurrentVersion);
